...
import com.charlesadebolaministries.kabodapp.listeners.ProgressListener
import com.charlesadebolaministries.kabodapp.util.StatusListElement
import com.charlesadebolaministries.kabodapp.util.populateImage
import kotlinx.android.synthetic.main.activity_status.*

class StatusListActivity : AppCompatActivity(), ProgressListener {
    ...
    companion object{
        ...
        fun getIntent(context: Context?, statusElement: StatusListElement): Intent {
            val intent = Intent(context, StatusListActivity::class.java)
