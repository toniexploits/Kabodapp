...
import com.charlesadebolaministries.kabodapp.contact.ContactsActivity
import com.charlesadebolaministries.kabodapp.listeners.FailureCallback
import com.charlesadebolaministries.kabodapp.profile.ProfileActivity
import com.charlesadebolaministries.kabodapp.ui.chat.ChatsFragment

import com.charlesadebolaministries.kabodapp.ui.status.StatusListFragment
import com.charlesadebolaministries.kabodapp.ui.statusupdate.StatusUpdateFragment
import com.charlesadebolaministries.kabodapp.ui.login.LoginActivity
...
class MainActivity : AppCompatActivity(), FailureCallback {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        super.onActivityResult(requestCode, resultCode, data) //just included this line
...
//                    val ph = user?.phone
//                    if(getPhoneSubstring(ph.toString()) == getPhoneSubstring(phone)){
//                        chatsFragment.newChat(documentSnapshot.id)
//                    }else{
//                        AlertDialog.Builder(this)
...
//                                        "It has many useful functionalities you would love. Click now to install it <<link>>")
...
//                }
    ...
    fun getPhoneSubstring(string: String): String{
